...
- **Measurement** attribute: a single-line field composed of a first field containing a quantity and a second field containing a measurement unit. It allows you to automatically convert measurement values into others to fit your export needs. You can check the [What about measurements](what-about-measurements) article to get more information about this feature.
