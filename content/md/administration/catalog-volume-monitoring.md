...
To do so, please refer to our technical documentation: over [here](https://docs.akeneo.com/latest/install_pim/manual/installation_ce.html#setup-akeneo) for CE and over [there](https://docs.akeneo.com/latest/install_pim/manual/installation_ee_archive.html#setup-akeneo) for EE.
:::
...
::: ee
In the Enterprise Edition, there are additional sections called `Axes on assets families` that will give you the volume regarding [assets](what-about-assets.html), and `Axes on reference entities` that will give you the volume regarding [reference entities](what-about-reference-entities.html).
:::
