...
| Edit options for single or multiple options attributes | User can manage the options for a single or multiple options attributes in `Attributes` tab, using the `Manage options` button |
| Remove an option    | User can remove an option of a single or multiple options attribute in `Attributes` tab, using the `Manage options` button and the `cross` in the list of options |
