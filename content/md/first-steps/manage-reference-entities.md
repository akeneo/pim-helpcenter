...
- This reference entity has some records: first, you need to [delete the records of this reference entity](enrich-your-reference-entity-records#delete-records.html).
