...
### Edit a media link attribute
 - *Prefix*: to put a prefix on all the media link (for example: `http://mydam.com/pictures/`)
 - *Suffix*: to put a suffix on all the media link (for example: `?width=800&format=jpg`)
