...
For instance, if your table attribute is used to list the ingredients of a product, each ingredient is an `option` of your `Select` column, this way you will be able to use it in the Product Edit Form.
