...
![Mass edit options](Products_BulkActionUppermenu.png)
1.  Click on `Bulk Actions`
1.  Select the operation to be performed from the screen menu
![Operations to be performed](Products_BulkAction2.png)
...
![Confirm button](Products_ConfirmBulkActions.png)
...
![Notification center](Products_MassEditNotifications.png)

To access the Execution details of the process, click on the notification icon.

![Process tracker](Products-ProcessTrackerReportMassEdit.png)
...
![Mass edit options](Products_BulkActionEditAttribute.png)
7.  Click on `Next`
...
6.  Add values for the selected attributes
![Mass edit options](Products_BulkActionAddAttribute.png)
7.  Click on `Next`
8.  Confirm the action with the `Confirm` button located in the middle of the screen
...
![Mass edit options](Products_BulkActionAddProductModel.png)
6.  Click on `Next`
...
Hereafter 2 examples of use cases:
  ...
  ![Mass edit options](Products_BulkActionChangeParentProductModelEx.png)
...
![Mass edit options](Products_BulkActionChangeParentProductModelSelect.png)
3.  Click on `Bulk Actions`
4.  Select `Change the parent product model` and then `Next`
5.  Select a family, a [family variant](what-about-products-variants.html#what-is-a-family-variant) and a [product model](what-about-products-variants.html#what-is-a-product-model)
![Mass edit options](Products_BulkActionChangeParentProductModel.png)
6.  Click on `Next`
7.  Confirm the action with the `Confirm` button located in the middle of the screen
...
5.  Select the association type
  ![Select association type](Products_BulkSelectAssociationType.png)
6.  Click on the `Add associations` button
  ![Add association](Products_BulkAddAssociation.png)
