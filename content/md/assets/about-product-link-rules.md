...
- a boolean [`abortion on error`](#Abortion-on-error) stating whether to abort the asset creation in case there was an error during the application of the naming convention.
