...
To see the format of the `product selection`, please read [this article](https://api.akeneo.com/concepts/asset-manager.html#product-selection) on our API website ;)
